...
Partial Class Form搜索
    ...
    Private Sub InitializeComponent()
        ...
        暗黑文本框1.Location = New Point(20, 20)
        暗黑文本框1.Margin = New Padding(20, 20, 10, 0)
        暗黑文本框1.Name = "暗黑文本框1"
        暗黑文本框1.Padding = New Padding(7, 6, 7, 0)
        暗黑文本框1.PasswordChar = vbNullChar
        暗黑文本框1.Size = New Size(445, 30)
        暗黑文本框1.TabIndex = 38
        ' 
        ' UiRadioButton1
        ' 
        ...
        UiRadioButton1.Size = New Size(132, 21)
        UiRadioButton1.Style = Sunny.UI.UIStyle.Custom
        UiRadioButton1.TabIndex = 39
        UiRadioButton1.Text = "模组项文件夹名称"
        ' 
        ' UiRadioButton2
        ' 
        ...
        UiRadioButton2.Location = New Point(20, 101)
        UiRadioButton2.Margin = New Padding(20, 10, 0, 0)
        UiRadioButton2.MinimumSize = New Size(1, 1)
        UiRadioButton2.Name = "UiRadioButton2"
        UiRadioButton2.Size = New Size(95, 21)
        UiRadioButton2.Style = Sunny.UI.UIStyle.Custom
        UiRadioButton2.TabIndex = 40
        UiRadioButton2.Text = "Name 键值"
        ' 
        ' UiRadioButton3
        ' 
        UiRadioButton3.Font = New Font("微软雅黑", 9.75F, FontStyle.Regular, GraphicsUnit.Point, CByte(134))
        UiRadioButton3.ForeColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        UiRadioButton3.Location = New Point(20, 132)
        UiRadioButton3.Margin = New Padding(20, 10, 0, 0)
        UiRadioButton3.MinimumSize = New Size(1, 1)
        UiRadioButton3.Name = "UiRadioButton3"
        UiRadioButton3.Size = New Size(101, 21)
        UiRadioButton3.Style = Sunny.UI.UIStyle.Custom
        UiRadioButton3.TabIndex = 41
        UiRadioButton3.Text = "Author 键值"
        ' 
        ' UiRadioButton4
        ' 
        UiRadioButton4.Font = New Font("微软雅黑", 9.75F, FontStyle.Regular, GraphicsUnit.Point, CByte(134))
        UiRadioButton4.ForeColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        UiRadioButton4.Location = New Point(20, 163)
        UiRadioButton4.Margin = New Padding(20, 10, 0, 0)
        UiRadioButton4.MinimumSize = New Size(1, 1)
        UiRadioButton4.Name = "UiRadioButton4"
        UiRadioButton4.Size = New Size(116, 21)
        UiRadioButton4.Style = Sunny.UI.UIStyle.Custom
        UiRadioButton4.TabIndex = 42
        UiRadioButton4.Text = "UniqueID 键值"
        ' 
        ' UiRadioButton5
        ' 
        UiRadioButton5.Font = New Font("微软雅黑", 9.75F, FontStyle.Regular, GraphicsUnit.Point, CByte(134))
        UiRadioButton5.ForeColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        UiRadioButton5.Location = New Point(20, 194)
        UiRadioButton5.Margin = New Padding(20, 10, 0, 0)
        UiRadioButton5.MinimumSize = New Size(1, 1)
        UiRadioButton5.Name = "UiRadioButton5"
        UiRadioButton5.Size = New Size(171, 21)
        UiRadioButton5.Style = Sunny.UI.UIStyle.Custom
        UiRadioButton5.TabIndex = 43
        UiRadioButton5.Text = "依赖项（反向搜索依赖）"
        ' 
        ' UiRadioButton6
        ' 
        UiRadioButton6.Font = New Font("微软雅黑", 9.75F, FontStyle.Regular, GraphicsUnit.Point, CByte(134))
        UiRadioButton6.ForeColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        UiRadioButton6.Location = New Point(20, 225)
        UiRadioButton6.Margin = New Padding(20, 10, 0, 0)
        UiRadioButton6.MinimumSize = New Size(1, 1)
        UiRadioButton6.Name = "UiRadioButton6"
        UiRadioButton6.Size = New Size(197, 21)
        UiRadioButton6.Style = Sunny.UI.UIStyle.Custom
        UiRadioButton6.TabIndex = 44
        UiRadioButton6.Text = "包含的文件夹（不含子目录）"
        ' 
        ' UiRadioButton7
        ' 
        UiRadioButton7.Font = New Font("微软雅黑", 9.75F, FontStyle.Regular, GraphicsUnit.Point, CByte(134))
        UiRadioButton7.ForeColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        UiRadioButton7.Location = New Point(20, 256)
        UiRadioButton7.Margin = New Padding(20, 10, 0, 0)
        UiRadioButton7.MinimumSize = New Size(1, 1)
        UiRadioButton7.Name = "UiRadioButton7"
        UiRadioButton7.Size = New Size(90, 21)
        UiRadioButton7.Style = Sunny.UI.UIStyle.Custom
        UiRadioButton7.TabIndex = 45
        UiRadioButton7.Text = "NEXUS ID"
        ' 
        ' UiRadioButton8
        ' 
        UiRadioButton8.Font = New Font("微软雅黑", 9.75F, FontStyle.Regular, GraphicsUnit.Point, CByte(134))
        UiRadioButton8.ForeColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        UiRadioButton8.Location = New Point(20, 287)
        UiRadioButton8.Margin = New Padding(20, 10, 0, 14)
        UiRadioButton8.MinimumSize = New Size(1, 1)
        UiRadioButton8.Name = "UiRadioButton8"
        UiRadioButton8.Size = New Size(106, 21)
        UiRadioButton8.Style = Sunny.UI.UIStyle.Custom
        UiRadioButton8.TabIndex = 46
        UiRadioButton8.Text = "ModDrop ID"
        ' 
        ' UiCheckBox1
        ' 
        ...
        UiCheckBox2.Size = New Size(119, 21)
        UiCheckBox2.Style = Sunny.UI.UIStyle.Custom
        UiCheckBox2.TabIndex = 48
        UiCheckBox2.Text = "不区分中英标点"
        ' 
        ' UiCheckBox3
        ' 
        ...
        UiCheckBox3.Location = New Point(290, 287)
        UiCheckBox3.Margin = New Padding(20, 10, 0, 0)
        UiCheckBox3.MinimumSize = New Size(1, 1)
        UiCheckBox3.Name = "UiCheckBox3"
        UiCheckBox3.Size = New Size(145, 21)
        UiCheckBox3.Style = Sunny.UI.UIStyle.Custom
        UiCheckBox3.TabIndex = 49
        UiCheckBox3.Text = "逐字拆分（特耗时）"
        ' 
        ' UiButton35
        ' 
        UiButton35.Anchor = AnchorStyles.Top Or AnchorStyles.Left Or AnchorStyles.Right
        ...
        UiButton35.Location = New Point(290, 70)
        ...
        UiButton35.Size = New Size(175, 35)
        UiButton35.Style = Sunny.UI.UIStyle.Custom
        UiButton35.TabIndex = 50
        UiButton35.TabStop = False
        UiButton35.Text = "开始搜索"
        ...
        UiButton1.Location = New Point(290, 115)
        UiButton1.Margin = New Padding(20, 10, 20, 0)
        ...
        UiButton1.Size = New Size(175, 35)
        ...
        Controls.Add(UiButton35)
        Controls.Add(UiCheckBox3)
        Controls.Add(UiCheckBox2)
        Controls.Add(UiCheckBox1)
        Controls.Add(UiRadioButton8)
        Controls.Add(UiRadioButton7)
        Controls.Add(UiRadioButton6)
        Controls.Add(UiRadioButton5)
        Controls.Add(UiRadioButton4)
        Controls.Add(UiRadioButton3)
